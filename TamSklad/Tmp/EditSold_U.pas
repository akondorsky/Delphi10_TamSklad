...
begin
    try
     try
        ...
        DM.Sql.Close;
        DM.Sql.SQL.Clear;
        DM.Sql.SQL.Add('insert into goods_EditSold (id_head,n_doc,date_doc,kol,kol_edizm,weight_vol,weight_edizm,stoim,owner) ');
        ...
        ModalResult:=mrOk;
        DM.Qry_GoodsEditSold.Close;
        DM.Qry_GoodsEditSold.Open;
        DM.Qry_GoodsEditSold.Last;
      except
